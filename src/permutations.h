...
// That is the permuted input has bit 58 of the input as its first bit, 
// bit 50 as its second bit, and so on with bit 7 as its last bit. 

// The output of that computation, called the preoutput, is then subjected 
// to the following permutation which is the inverse of the initial permutation:
static const char IPR[64] = {
...
static const char E_TABLE[48] = {
    32,  1,  2,  3,  4,  5, // Block 1
     4,  5,  6,  7,  8,  9, // Block 2
     8,  9, 10, 11, 12, 13, // Block 3
    12, 13, 14, 15, 16, 17, // Block 4
    16, 17, 18, 19, 20, 21, // Block 5
...
// and is illustrated by using one of the following tables: 
static const char S_TABLES[8][64] = {
    { // S1
...
// Such a function is defined by the following table: 
